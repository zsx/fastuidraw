...
main(int argc, char **argv)
{
  std::cout << std::setw(40) << "header_size = " << PainterHeader::header_size << "\n"
            ...
            << std::setw(40) << "linear_gradient_data_size = " << LinearGradientParams::data_size << "\n"
            << std::setw(40) << "radial_gradient_data_size = " << RadialGradientParams::data_size << "\n"
            << std::setw(40) << "repeat_window_data_size = " << RepeatWindowParams::data_size << "\n"
            << std::setw(40) << "transformation_matrix_data_size = " << TransformationMatrixParams::data_size << "\n"
