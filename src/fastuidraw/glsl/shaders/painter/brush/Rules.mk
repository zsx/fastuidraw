...
LIBRARY_RESOURCE_STRING += $(call filelist, \
	fastuidraw_painter_brush_util.glsl.resource_string \
	fastuidraw_painter_brush_unified.glsl.resource_string \
	fastuidraw_painter_brush_uber.glsl.resource_string \
